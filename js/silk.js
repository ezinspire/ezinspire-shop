...
function drawSilkAnimation() {
    ...
    let lowestWavePoint = height * 0.5;
    ...
    for (let i = 0; i < width; i++) {
        ...
        if (yPosition > lowestWavePoint) {
            lowestWavePoint = yPosition;
        }
    }
    ...
    const linearGradient = ctx.createLinearGradient(0, lowestWavePoint - 130, width, height);
